...
// Render markdown with proper container styling and syntax highlighting
function renderMarkdown(text) {
    ...
    // Process code blocks: ensure single container and add copy buttons
    const tempDiv = document.createElement('div');
    tempDiv.innerHTML = html;
    
    // Handle code blocks generated by markdown-it
    tempDiv.querySelectorAll('pre code').forEach((codeElement) => {
        ...
        // Replace the pre element with our code block
        pre.replaceWith(codeBlockDiv);
    });
