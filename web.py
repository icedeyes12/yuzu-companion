...
@app.route('/chat')
def chat():
    global web_session_started
    
    profile = Database.get_profile()
    
    if not web_session_started:
        ...
        Database.add_message('system', connection_msg)
        web_session_started = True
        print("Web session greeting added")
...
def api_browser_unload():
    ...
    web_session_started = False
    print("Web page closed or refreshed")
